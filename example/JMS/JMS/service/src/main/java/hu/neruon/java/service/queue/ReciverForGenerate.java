 ...
 */
@Singleton(name = "ReciverForGenerate", mappedName = "ReciverForGenerate")
@Remote(ReciverRemote.class)
public class ReciverForGenerate implements ReciverRemote {
	private static final Logger logger = Logger
			.getLogger(ReciverForGenerate.class);
	...
	public MessageVO consum() throws Exception {
