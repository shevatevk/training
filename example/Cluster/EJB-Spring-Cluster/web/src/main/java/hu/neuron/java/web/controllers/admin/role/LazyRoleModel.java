...
public class LazyRoleModel extends LazyDataModel<RoleVO> {
	...
	private UserFacadeRemote userService;

	public LazyRoleModel(UserFacadeRemote userService) {
		super();
	...
	public UserFacadeRemote getUserService() {
		return userService;
	}

	public void setUserService(UserFacadeRemote userService) {
		this.userService = userService;
	}
