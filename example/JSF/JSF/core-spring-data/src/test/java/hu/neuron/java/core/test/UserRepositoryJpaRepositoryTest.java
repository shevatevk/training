...
public class UserRepositoryJpaRepositoryTest {

	private static final Logger logger = Logger
			.getLogger(UserRepositoryJpaRepositoryTest.class);
	...
	public void test1Save() {
		try {
			...
			users = (ArrayList<User>) repository.save(users);
	...
	public void test3Paging() {
		try {
			...
			userpage = repository.findAll(pageable2);
